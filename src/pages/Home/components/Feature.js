...
function Feature() {
  return (
    <div className="min-h-screen font-sans text-slate-100 selection:bg-blue-100 p-6 md:p-12 flex flex-col items-center">
      {/* --- HEADER --- */}
      <div className="text-center max-w-3xl mx-auto mb-16 md:mb-24 mt-10">
        ...
        <p className="text-slate-200 text-lg md:text-xl leading-relaxed max-w-2xl mx-auto">
          transforma tus pensamientos dispersos en memorias estructuradas que te
          ayudan a actuar, concentrarte y, por fin, sentir alivio.
        </p>
      </div>
        ...
        <div className="space-y-16 pl-4 md:pl-10 order-2 md:order-1">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xl text-slate-300 leading-relaxed max-w-md">
              Envía un mensaje, una nota de voz o una captura de pantalla. lo
              recuerda por ti.
            </p>
          </div>
          ...
          <div className="space-y-4  hover:opacity-100 transition-opacity duration-500 cursor-default">
            ...
            <p className="text-xl text-slate-300 leading-relaxed max-w-md">
              Tus ideas, enlaces y conversaciones se agrupan por contexto,
              personas e intención.
            </p>
          </div>
        </div>

        {/* COLUMNA DERECHA (Teléfono) */}
        <div className="flex justify-center md:justify-end order-1 md:order-2 text-slate-900">
          {/* MARCO DEL TELÉFONO */}
            ...
            <div className="flex-1 bg-[#FDFCF8] p-4 flex flex-col gap-4 overflow-y-auto text-[13px] leading-snug">
              ...
              <div className="self-start max-w-[85%]">
                <div className="bg-white p-3 rounded-lg rounded-tl-none shadow-sm border border-slate-100">
                  <p>
                    He agrupado todo bajo el contexto Campañas Q4. Ya está junto
                    a tus notas del Black Friday 😉
                  </p>
                </div>
              ...
              <div className="self-end max-w-[85%] flex flex-col items-end">
                <div className="bg-[#E7FFDB] p-3 rounded-lg rounded-tr-none shadow-sm border border-green-100">
                  <p>
                    Cuál era el enlace de la reunión con el equipo de diseño?
                  </p>
                </div>
                ...
                <div className="bg-white p-3 rounded-lg rounded-tl-none shadow-sm border border-slate-100">
                  <p>
                    ...
                    <span className="text-blue-500 underline cursor-pointer">
                      meet.google.com/design
                    </span>{" "}
                    Recuerda que la reunión es el próximo lunes a las 10:30.
                  </p>
                </div>
                <span className="text-[10px] text-slate-400 mt-1 ml-1 block">
                  8:26 PM
              ...
              <div className="self-start max-w-[85%]">
                <div className="bg-white p-3 rounded-lg rounded-tl-none shadow-sm border border-slate-100">
                  <p>
                    ¿Quieres que le mande un recordatorio a Jorge media hora
                    antes de la reunión para que te mande los gráficos?
                  </p>
                </div>
                <span className="text-[10px] text-slate-400 mt-1 ml-1 block">
                  8:28 PM
