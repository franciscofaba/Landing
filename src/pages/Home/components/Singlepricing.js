      ...
      <div className="relative z-10 max-w-5xl w-full">
        ...
        <div className="text-center mb-12 space-y-4">
          ...
          <p className="text-lg md:text-xl text-slate-400 max-w-2xl mx-auto">
            Todo lo que tienes en la cabeza, ahora en un plan claro y manejable.
          </p>
        </div>
            ...
            <div className="lg:col-span-2 p-8 md:p-12 flex flex-col justify-center border-b lg:border-b-0 lg:border-r border-slate-800 bg-slate-900/40 relative">
              ...
              <div className="mt-8 mb-6">
                ...
                <p className="text-sm text-slate-400">
                  Para quienes quieren control total sin esfuerzo.
                </p>
              </div>
              ...
              <div className="mt-10 p-4 rounded-xl bg-slate-800/50 border border-slate-700/50 flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-sm font-bold text-slate-200">
                    Bonus: Acceso anticipado
                  </h4>
                  <p className="text-xs text-slate-400 mt-1">
                    Sé el primero en probar las nuevas funciones de voz antes
                    que nadie.
                  </p>
                </div>
              </div>
    ...
    <div className="flex items-start gap-3">
      <div
        className={`mt-0.5 shrink-0 rounded-full p-0.5 ${
          highlighted ? "bg-purple-500/20" : "bg-slate-800"
        }`}
      >
        <Check
          className={`w-3.5 h-3.5 ${
            highlighted ? "text-purple-400" : "text-slate-400"
          }`}
          strokeWidth={3}
        />
      </div>
      <span
        className={`text-sm ${
          highlighted ? "text-white font-medium" : "text-slate-300"
        }`}
      >
        {text}
      </span>
